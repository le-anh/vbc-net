    ...
    */
    ...
    $('#w1').bootstrapWizard({
        ...
        onNext: function(tab, navigation, index, newindex) {
            var validated = $('#w1 form').valid();
            console.log("beneficiary-account: "+ $('#beneficiary-account').val());
            ...
            if (!validated) {
                ...
                .done(function(msg) {
                    ...
                    $('#td-beneficiary-token').html(msg.result);
                    receiver = msg.result;
                    ...
                    .done(function(msg) {
                        amountAvailable = msg.amount;
                        $('#td-amount').html($('#amount').val());
                        sender = msg.owner;
                        utxoInputKeys = [msg.utxo_key];
                        amount = $('#amount').val();
                        sum = msg.amount;
                    });

                    if (parseInt(amountAvailable) < parseInt($('#amount').val())) {
                ...
                .fail(function(msg){
                    ...
                    $('#beneficiary-account-mesage').html('Not found beneficiary account!');
                    $('#beneficiary-account-mesage').css('display', 'block');
